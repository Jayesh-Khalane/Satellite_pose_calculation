...
def main():
    ...
    with open("pose_data.csv", "w", newline="") as csvfile:
        ...
        # Write headers matching your data analyzer script
        csv_writer.writerow(["timestamp", "x_cm", "y_cm", "z_cm", "roll_deg", "pitch_deg", "yaw_deg"])
        
        start_time = time.time()
        print("Logging to pose_data.csv started... Press ESC to stop.")
        ...
        while True:
            ...
            if len(world_coords) == 3 and labels:
                ...
                if centroid is not None:
                    ...
                    csv_writer.writerow([elapsed_time, centroid[0], centroid[1], centroid[2], euler[0], euler[1], euler[2]])
    ...
    print("Camera closed safely. Data saved successfully.")
